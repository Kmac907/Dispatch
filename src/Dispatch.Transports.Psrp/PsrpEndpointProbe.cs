...
public sealed class PsrpEndpointProbe(
    IPsrpDnsResolver dnsResolver,
    IPsrpPortProbe portProbe) : ITransportEndpointProbe
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (http.Succeeded)
        {
            ...
            metadata["protocol"] = "psrp-over-wsman";
        ...
        return Failed(
            ...
            $"PSRP WinRM ports are unreachable for '{request.Target.Target.Name}'. HTTP: {http.FailureMessage} HTTPS: {https.FailureMessage}",
            metadata);
    }
