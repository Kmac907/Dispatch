...
- PSCredential PowerShell-wrapper handoff, raw WinRM credential handoff, PsExec credential handoff, DPAPI protected-file ACL hardening, and job-file credential validation remain in later slices. Job-file validation depends on Roadmap `6.5` introducing the YAML job parser.
