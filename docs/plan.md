...
- `Dispatch.Transports.WinRm` is a partially implemented raw WinRM transport with current request-validation, planning, DI, endpoint-probe coverage, chunked script-transfer preparation planning, and remote script upload; WS-Management shell/command execution remains roadmap work.
...
winrm  + ScriptPayload   = partial; planning, probe, chunked script-transfer preparation planning, and remote upload implemented, explicit not-yet-implemented shell execution failure remains
