...
- Runtime credential resolution/transport handoff, broader global config-file credential validation, and job-file credential validation remain in later slices. Job-file validation depends on Roadmap `6.5` introducing the YAML job parser.
