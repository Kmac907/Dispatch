...
- `dispatch hosts list`, `dispatch hosts validate`, `dispatch hosts test`, `dispatch hosts graph`, and `dispatch hosts vars` are implemented; expanded transport-aware `doctor` behavior remains later `6.6` work.
