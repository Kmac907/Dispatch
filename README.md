...
- Current PowerShell module diagnostic/version wrappers over the same `dispatch.exe` command surface; execution wrappers and credential handoff remain planned Roadmap 7 work.
